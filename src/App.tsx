        ...
        <div className="min-h-screen bg-white">
            ...
            <section className="relative py-20 bg-gradient-to-r from-blue-50 to-blue-100 text-[#1D4ED8] overflow-hidden">
                <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <div className="bg-white bg-opacity-90 backdrop-blur-sm rounded-3xl p-8 shadow-lg">
                        <div className="mb-8">
                            <Gift className="w-16 h-16 mx-auto mb-4 text-[#1D4ED8]" />
                            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-[#1D4ED8]">
                                BÔNUS EXCLUSIVO
                            </h2>
                        </div>
                        <div className="bg-gradient-to-r from-blue-100 to-blue-200 bg-opacity-50 backdrop-blur-lg rounded-2xl p-8 max-w-3xl mx-auto">
                            <div className="flex items-center justify-center mb-4">
                                <Download className="w-8 h-8 mr-3 text-[#1D4ED8]" />
                                <h3 className="text-xl md:text-2xl font-semibold text-[#1D4ED8]">
                        ...
                        <button
                            onClick={() => {
                                window.location.href =
                                    "https://buy.stripe.com/dRm9AS3Q31FK4o60Un93y01";
                            }}
